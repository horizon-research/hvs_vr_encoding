...
def get_args():
    ...
    parser.add_argument('--h_fov', type=float, default=110.0, help='horizontal_fov')
    ...
    parser.add_argument('--max_ecc', type=float, default=35.0, help='max_ecc')
    parser.add_argument('--fixed_c', type=float, default=1e-3, help='c will be fixed to this value, since we empirically found that predicted c_s were too small')
    parser.add_argument('--ecc_no_compress', type=float, default=15.0, help='ecc (deg) smaller than this value will not be compressed (I will set abc = 1e-5)')

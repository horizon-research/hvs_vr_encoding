...
def get_args():
    ...
    parser.add_argument('--skip_interval', type=int, default=3, help='port for video display')
    parser.add_argument('--video_num', type=int, default=5, help='port for video display')

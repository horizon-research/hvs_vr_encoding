...
pre_distortion_precompute_module = Extension(
    name='pre_distortion_precompute',  # Name of the module
    sources=['pre_distortion_precompute.cpp'],  # Source file
...
setup(
    name='pre_distortion_precompute',  # Name of the package
    version='1.0',  # Version number
    description='A Python module for reading matrices from files using C++ and pybind11',  # Description
    ext_modules=[pre_distortion_precompute_module]  # List of extension modules
)